class Vte3Roi < Formula
  ...
  conflicts_with "vte3", :because => "vte3 is what we want"
...
__END__
diff -Naur vte-0.42.1-orig/src/pty.cc vte-0.42.1/src/pty.cc
--- vte-0.42.1-orig/src/pty.cc	2015-04-29 11:46:12.000000000 +0200
+++ vte-0.42.1/src/pty.cc	2016-01-05 15:14:44.000000000 +0100
@@ -734,6 +734,8 @@
                 return -1;
         }
